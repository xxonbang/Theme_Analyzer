...
const STATUS_CONFIG: Record<string, { label: string; cls: string }> = {
  hit: { label: "적중", cls: "bg-emerald-100 dark:bg-emerald-500/15 text-emerald-700 dark:text-emerald-400" },
  missed: { label: "미스", cls: "bg-red-100 dark:bg-red-500/15 text-red-700 dark:text-red-400" },
  expired: { label: "만료", cls: "bg-slate-100 dark:bg-slate-500/15 text-slate-500 dark:text-slate-400" },
  active: { label: "평가중", cls: "bg-blue-100 dark:bg-blue-500/15 text-blue-600 dark:text-blue-400" },
}
