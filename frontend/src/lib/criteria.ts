...
export const CRITERIA_CONFIG = [
  ...
  { key: "golden_cross", dot: "bg-yellow-500", badge: "bg-yellow-500/15 text-yellow-700 dark:text-yellow-400", label: "골든크로스", shortLabel: "GC", warning: false, description: "EMA, MACD, 스토캐스틱, RSI, 볼린저, ADX, OBV 중 골든크로스 발생" },
